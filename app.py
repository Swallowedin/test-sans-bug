...
def display_loading_animation():
    ...
    <div style="display: flex; align-items: center; justify-content: center; flex-direction: column;">
        ...
        <p style="margin-top: 10px; font-weight: bold;">Notre IA analyse votre cas juridique...</p>
        <p>Votre estimation est en cours d'élaboration !</p>
    </div>
    """, unsafe_allow_html=True)
...
def main():
    ...
    if st.button("Obtenir une estimation grâce à notre intelligence artificielle"):
        if question:
            try:
